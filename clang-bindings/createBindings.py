...
with open(pc_ble_drive_root+"\\src\\sd_api_v3\\bindings\\emscripten_bindings.cpp", "w") as file:
    file.write(source_code)
with open(pc_ble_drive_root+"\\src\\js\\bindings\\emscripten.js", "w") as file:
